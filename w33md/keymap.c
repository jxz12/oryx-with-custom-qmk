...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_AT,          DM_PLY1,        KC_2,           KC_3,           KC_4,           KC_5,           TD(DANCE_0),                                    KC_AUDIO_MUTE,  KC_6,           KC_7,           KC_8,           KC_9,           DM_REC1,        KC_EQUAL,
  ...
  [1] = LAYOUT_ergodox_pretty(
    KC_NUM,         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    ...
    KC_TRANSPARENT, KC_COMMA,       KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_KP_PLUS,                                                                     KC_PERC,        KC_LCBR,        KC_RCBR,        KC_LPRN,        KC_COLN,        KC_TRANSPARENT,
    ...
    KC_TRANSPARENT, KC_KP_DOT,      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_BSLS,        KC_TRANSPARENT,
  ...
  [3] = LAYOUT_ergodox_pretty(
    KC_SCRL,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [4] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, RGB_HUI,        RGB_SAI,        RGB_VAI,        KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_F7,          KC_F8,          KC_F9,          KC_TRANSPARENT, KC_TRANSPARENT,
    LED_LEVEL,      RGB_SPI,        RGB_HUD,        RGB_SAD,        RGB_VAD,        KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_F4,          KC_F5,          KC_F6,          KC_F10,         KC_TRANSPARENT,
    KC_TRANSPARENT, RGB_SPD,        RGB_MODE_FORWARD,RGB_SLD,        TOGGLE_LAYER_COLOR,KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_F1,          KC_F2,          KC_F3,          KC_F11,         KC_TRANSPARENT,
...
void dance_0_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        case SINGLE_TAP: register_code16(LGUI(LSFT(KC_3))); break;
        ...
        case DOUBLE_SINGLE_TAP: tap_code16(LGUI(LSFT(KC_3))); register_code16(LGUI(LSFT(KC_3)));
    }
}
...
void dance_0_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[0].step) {
        case SINGLE_TAP: unregister_code16(LGUI(LSFT(KC_3))); break;
        ...
        case DOUBLE_SINGLE_TAP: unregister_code16(LGUI(LSFT(KC_3))); break;
    }
